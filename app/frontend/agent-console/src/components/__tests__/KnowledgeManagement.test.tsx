...
const mockScrapingJobs = [
  {
    ...
    staging_file_path: '/tmp/mock-job-1.json',
    selected_links: ['https://example.com/about'],
    indexing_started_at: '2023-01-01T00:30:00Z',
    indexing_completed_at: '2023-01-01T01:00:00Z',
  },
  {
    id: '2',
    tenant_id: 'tenant-1',
    ...
    pages_scraped: 5,
    total_pages: 8,
    started_at: '2023-01-02T00:05:00Z',
    created_at: '2023-01-02T00:00:00Z',
    completed_at: null,
    updated_at: '2023-01-02T00:30:00Z',
    staging_file_path: '/tmp/mock-job-2.json',
    selected_links: [],
